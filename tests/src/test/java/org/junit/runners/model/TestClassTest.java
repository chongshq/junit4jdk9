...
public class TestClassTest {
    ...
    public void fieldsOnSubclassesDoNotShadowSuperclasses() {
        MatcherAssert.assertThat(new TestClass(SubclassWithField.class).getAnnotatedFields(
    ...
    public void dontMarkNonInnerClassAsInnerClass() {
        MatcherAssert.assertThat(new TestClass(SimpleClass.class).isANonStaticInnerClass(),
                is(false));
    }
    ...
    public void hasSameHashCodeAsTestClassThatWrapsSameJavaClass() {
        ...
        TestClass testClassThatWrapsSameJavaClass = new TestClass(
                DummyClass.class);
        Assert.assertEquals(testClass.hashCode(),
