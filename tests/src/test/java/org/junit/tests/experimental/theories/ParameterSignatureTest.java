...
public class ParameterSignatureTest {
    ...
    public void getType(Method method, int index) {
        Assume.assumeTrue(index < method.getParameterTypes().length);
        Assert.assertEquals(method.getParameterTypes()[index], ParameterSignature
