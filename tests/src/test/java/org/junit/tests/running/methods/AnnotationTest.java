...
public class AnnotationTest extends TestCase {
    ...
    public void testTestAndTeardownFailure() throws Exception {
        ...
        MatcherAssert.assertThat(runner.getFailures().toString(), allOf(containsString("hereAfter"), containsString("inTest")));
    }
    ...
    public void testShadowing() throws Exception {
        log = "";
        MatcherAssert.assertThat(PrintableResult.testResult(SubShadowing.class), ResultMatchers.isSuccessful());
        assertEquals(
    ...
    public void testStaticMethodsCanBeTreatedAsShadowed() throws Exception {
        log = "";
        MatcherAssert.assertThat(PrintableResult.testResult(SubStaticMethodShadowing.class), ResultMatchers.isSuccessful());
        assertEquals(
                "sub.rule().before() "
                + "Test "
                + "sub.rule().after() ",
    ...
    public void testFieldsNeverTreatedAsShadowed() throws Exception {
        log = "";
        MatcherAssert.assertThat(PrintableResult.testResult(SubFieldShadowing.class), ResultMatchers.isSuccessful());
        assertEquals(
    ...
    public void testStaticFieldsCanBeTreatedAsShadowed() throws Exception {
        log = "";
        MatcherAssert.assertThat(PrintableResult.testResult(SubStaticFieldShadowing.class), ResultMatchers.isSuccessful());
        assertEquals(
                "sub.rule.before() "
                + "Test "
                + "sub.rule.after() ",
