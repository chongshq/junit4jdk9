...
public class ParentRunnerClassLoaderTest {
    ...
    public void testClassRuleAccessToClassInAnotherClassLoader() throws Exception {
        ...
        Assert.assertEquals("JUnitRunner can be located in own classLoader, so, " +
    ...
    public void testDescriptionContainCorrectTestClass() throws Exception {
        ...
        Assert.assertEquals("ParentRunner accept already instantiate Class<?> with tests, if we lost it instance, and will " +
    ...
    public void testBackwardCompatibilityWithOverrideGetName() throws Exception {
        ...
        Assert.assertEquals("Subclass of ParentRunner can override getName method and specify another test class for run, " +
