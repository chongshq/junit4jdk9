...
//  }
    ...
    public void multiDimensionalArraysAreEqual() {
        Assert.assertArrayEquals((new Object[][]{{true, true}, {false, false}}), (new Object[][]{{true, true}, {false, false}}));
    }
    ...
    public void multiDimensionalArraysDifferentLengthMessage() {
        try {
            Assert.assertArrayEquals("message", new Object[][]{{true, true}, {false, false}}, new Object[][]{{true, true}, {false}});
        } catch (AssertionError exception) {
    ...
    public void multiDimensionalArraysDifferentLengthNoMessage() {
        try {
            Assert.assertArrayEquals(new Object[][]{{true, true}, {false, false}}, new Object[][]{{true, true}, {false}});
        } catch (AssertionError exception) {
    ...
    public void sameWithMessage() {
        try {
            ...
            Assert.assertEquals("not same expected same:<hello> was not:<good-bye>",
    ...
    public void assertThatIncludesDescriptionOfTestedValueInErrorMessage() {
        ...
        try {
            Assert.assertThat("identifier", actual, equalTo(expected));
        } catch (AssertionError e) {
            Assert.assertEquals(expectedMessage, e.getMessage());
            return;
        }
    ...
    public void assertThatIncludesAdvancedMismatch() {
        ...
        try {
            Assert.assertThat("identifier", "actual", is(instanceOf(Integer.class)));
        } catch (AssertionError e) {
            Assert.assertEquals(expectedMessage, e.getMessage());
            return;
        }
    ...
    public void assertNotEqualsWorksWithPrimitiveTypes() {
        ...
        Assert.assertNotEquals(1.0f, 2.0f, 0f);
        Assert.assertNotEquals("The values should be different", 1.0f, 2.0f, 0f);
    }
    ...
    public void assertNotEqualsIgnoresFloatDeltaOnNaN() {
        Assert.assertNotEquals(Float.NaN, Float.NaN, 1f);
    }

    @Test(expected = AssertionError.class)
    public void assertThrowsRequiresAnExceptionToBeThrown() {
        Assert.assertThrows(Throwable.class, nonThrowingRunnable());
    }
    ...
    public void assertThrowsIncludesTheSpecifiedMessage() {
        try {
            Assert.assertThrows("Foobar", Throwable.class, nonThrowingRunnable());
        } catch (AssertionError ex) {
            Assert.assertEquals(
    ...
    public void assertThrowsReturnsTheSameObjectThrown() {
        ...
        Throwable throwable = Assert.assertThrows(Throwable.class, throwingRunnable(npe));
    ...
    public void assertThrowsDetectsTypeMismatchesViaExplicitTypeHint() {
        ...
        Assert.assertThrows(IOException.class, throwingRunnable(npe));
    }
    ...
    public void assertThrowsSuppliesACoherentErrorMessageUponTypeMismatch() {
        ...
        try {
            ...
            Assert.assertEquals("unexpected exception type thrown; expected:<java.io.IOException> but was:<java.lang.NullPointerException>",
                    error.getMessage());
    ...
    public void assertThrowsSuppliesTheSpecifiedMessageUponTypeMismatch() {
        ...
        try {
            Assert.assertThrows("Foobar", IOException.class, throwingRunnable(npe));
        } catch (AssertionError error) {
            Assert.assertEquals("Foobar: unexpected exception type thrown; expected:<java.io.IOException> but was:<java.lang.NullPointerException>",
                    error.getMessage());
            Assert.assertSame(npe, error.getCause());
            return;
        }
