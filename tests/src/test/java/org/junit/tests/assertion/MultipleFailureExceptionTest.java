...
public class MultipleFailureExceptionTest {
    ...
    public void assertEmptyThrowsMultipleFailureExceptionForManyThrowables() throws Exception {
        ...
        try {
            ...
            MatcherAssert.assertThat(expected.getFailures(), equalTo(errors));
            Assert.assertTrue(expected.getMessage().startsWith("There were 2 errors:" + LINE_SEPARATOR));
            Assert.assertTrue(expected.getMessage().contains("ExpectedException(basil)" + LINE_SEPARATOR));
    ...
    public void assertEmptyWrapsAssumptionFailuresForManyThrowables() throws Exception {
        ...
        try {
            ...
            MatcherAssert.assertThat(expected.getFailures().size(), equalTo(2));
            Assert.assertTrue(expected.getMessage().startsWith("There were 2 errors:" + LINE_SEPARATOR));
