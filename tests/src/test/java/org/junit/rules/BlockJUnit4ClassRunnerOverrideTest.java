...
public class BlockJUnit4ClassRunnerOverrideTest {
    ...
    public void overrideRulesMethod() {
        Assert.assertThat(PrintableResult.testResult(OverrideTestRulesTest.class), ResultMatchers.isSuccessful());
    }
    ...
    public void overrideTestRulesMethod() {
        Assert.assertThat(PrintableResult.testResult(OverrideRulesTest.class), ResultMatchers.isSuccessful());
    }
    ...
    public void overrideCreateTestMethod() {
        Assert.assertThat(PrintableResult.testResult(OverrideCreateTest.class), ResultMatchers.isSuccessful());
    }
    ...
    public void createTestDefersToNoArgCreateTest() {
        Assert.assertThat(PrintableResult.testResult(CreateTestDefersToNoArgCreateTestTest.class), ResultMatchers.isSuccessful());
    }
}
