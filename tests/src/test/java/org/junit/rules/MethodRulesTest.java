...
public class MethodRulesTest {
    ...
    public void ruleIsIntroducedAndEvaluated() {
        ...
        Assert.assertThat(PrintableResult.testResult(ExampleTest.class), ResultMatchers.isSuccessful());
        Assert.assertTrue(ruleWasEvaluated);
    }
    ...
    public void ruleIsIntroducedAndEvaluatedOnSubclass() {
        ruleWasEvaluated = false;
        Assert.assertThat(PrintableResult.testResult(SonOfExampleTest.class), ResultMatchers.isSuccessful());
        Assert.assertTrue(ruleWasEvaluated);
    }
    ...
    public void ruleIsIntroducedAndEvaluatedOnSubclassOfNonPublicClass() {
        ruleWasEvaluated = false;
        Assert.assertThat(PrintableResult.testResult(SonOfNonPublicExampleTest.class), ResultMatchers.isSuccessful());
        Assert.assertTrue(ruleWasEvaluated);
    }
    ...
    public void multipleRulesAreRun() {
        runCount = 0;
        Assert.assertThat(PrintableResult.testResult(MultipleRuleTest.class), ResultMatchers.isSuccessful());
        Assert.assertEquals(2, runCount);
    }
    ...
    public void ignoreNonRules() {
        Assert.assertThat(PrintableResult.testResult(NoRulesTest.class), ResultMatchers.isSuccessful());
    }
    ...
    public void onFailure() {
        log = "";
        Assert.assertThat(PrintableResult.testResult(OnFailureTest.class), ResultMatchers.failureCountIs(1));
        Assert.assertEquals("nothing AssertionError", log);
    }
    ...
    public void succeeded() {
        ...
        Assert.assertThat(PrintableResult.testResult(WatchmanTest.class), ResultMatchers.failureCountIs(1));
        Assert.assertThat(WatchmanTest.watchedLog, containsString("fails AssertionError"));
        Assert.assertThat(WatchmanTest.watchedLog, containsString("succeeds success!"));
    }
    ...
    public void beforesAndAfters() {
        ...
        Assert.assertThat(PrintableResult.testResult(BeforesAndAfters.class), ResultMatchers.isSuccessful());
        Assert.assertThat(BeforesAndAfters.watchedLog, is("starting before test after succeeded finished "));
    }
    ...
    public void validateWrongTypedField() {
        Assert.assertThat(PrintableResult.testResult(WrongTypedField.class),
                ResultMatchers.hasSingleFailureContaining("must implement MethodRule"));
    }
    ...
    public void validateWrongTypedFieldInSuperclass() {
        Assert.assertThat(PrintableResult.testResult(SonOfWrongTypedField.class),
                ResultMatchers.hasSingleFailureContaining("must implement MethodRule"));
    }
    ...
    public void validatePrivateRule() {
        Assert.assertThat(PrintableResult.testResult(PrivateRule.class),
                ResultMatchers.hasSingleFailureContaining("must be public"));
    }
    ...
    public void useCustomMethodRule() {
        Assert.assertThat(PrintableResult.testResult(UsesCustomMethodRule.class), ResultMatchers.isSuccessful());
    }
    ...
    public void runsMethodRuleThatIsReturnedByMethod() {
        ruleWasEvaluated = false;
        Assert.assertThat(PrintableResult.testResult(HasMethodReturningMethodRule.class), ResultMatchers.isSuccessful());
        Assert.assertTrue(ruleWasEvaluated);
    }
    ...
    public void runsAllMethodRulesThatAreReturnedByMethods() {
        runCount = 0;
        Assert.assertThat(PrintableResult.testResult(HasMultipleMethodsReturningMethodRule.class), ResultMatchers.isSuccessful());
        Assert.assertEquals(2, runCount);
    }
    ...
    public void callsMethodReturningRuleOnlyOnce() {
        Assert.assertThat(PrintableResult.testResult(CallsMethodReturningRuleOnlyOnce.class), ResultMatchers.isSuccessful());
    }
}
