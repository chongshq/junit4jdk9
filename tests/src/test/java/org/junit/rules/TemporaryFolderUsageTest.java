...
public class TemporaryFolderUsageTest {
    ...
    public void newNamedFileIsCreatedUnderRootFolder() throws IOException {
        ...
        Assert.assertThat("file name", f.getName(), equalTo(fileName));
    }
    ...
    private File createTemporaryFolder() throws IOException {
        ...
        Assert.assertTrue("Unable to delete temporary file", tempDir.delete());
        Assert.assertTrue("Unable to create temp directory", tempDir.mkdir());
        return tempDir;
    }
    ...
    private void checkFileExists(String msg, File file, boolean exists) {
        Assert.assertThat("File is null", file, is(notNullValue()));
        Assert.assertThat("File '" + file.getAbsolutePath() + "' " + msg,
    ...
    private void assertParentFolderForFileIs(File f, File parentFolder) {
        Assert.assertThat("'" + f.getAbsolutePath() + "': not under root",
