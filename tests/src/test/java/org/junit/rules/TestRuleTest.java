...
public class TestRuleTest {
    ...
    public void onlyApplyOnceEvenIfImplementsBothInterfaces() {
        Assert.assertTrue(JUnitCore.runClasses(OneFieldTwoKindsOfRule.class).wasSuccessful());
    }
    ...
    public void beforesAndAfters() {
        ...
        Assert.assertThat(BeforesAndAfters.watchedLog.toString(),
    ...
    public void methodOnlyApplyOnceEvenIfImplementsBothInterfaces() {
        Assert.assertTrue(JUnitCore.runClasses(MethodOneFieldTwoKindsOfRule.class).wasSuccessful());
    }
    ...
    public void beforesAndAftersAreEnclosedByRule() {
        ...
        Assert.assertEquals("starting before test after succeeded finished ",
    ...
    public void methodValidateWrongTypedField() {
        Assert.assertThat(PrintableResult.testResult(MethodWrongTypedField.class),
                ResultMatchers.hasSingleFailureContaining("must return an implementation of MethodRule"));
    }
    ...
    public void methodValidateWrongTypedFieldInSuperclass() {
        Assert.assertThat(PrintableResult.testResult(MethodSonOfWrongTypedField.class),
                ResultMatchers.hasSingleFailureContaining("must return an implementation of MethodRule"));
    }
    ...
    public void methodValidatePrivateRule() {
        Assert.assertThat(PrintableResult.testResult(MethodPrivateRule.class),
                ResultMatchers.hasSingleFailureContaining("must be public"));
    }
    ...
    public void methodUseCustomMethodRule() {
        Assert.assertThat(PrintableResult.testResult(MethodUsesCustomMethodRule.class), ResultMatchers.isSuccessful());
    }
    ...
    public void testRuleIsAroundMethodRule() {
        ...
        Assert.assertEquals(" testRule.begin methodRule.begin foo methodRule.end testRule.end",
                ruleLog.toString());
    }
    ...
    public void testRuleOrdering() {
        ...
        Assert.assertTrue(result.wasSuccessful());
        Assert.assertEquals(" outer.begin inner.begin foo inner.end outer.end", ruleLog.toString());
    }
    ...
    public void testRuleOrderingWithMethodRule() {
        ...
        Assert.assertTrue(result.wasSuccessful());
        Assert.assertEquals(" methodRule.begin testRule.begin foo testRule.end methodRule.end",
                ruleLog.toString());
    }
}
