...
public class RunNotifierTest {
    ...
    public void notifiesSecondListenerIfFirstThrowsException() {
        ...
        Assert.assertNotNull("The FailureListener registered no failure.",
    ...
    public void addAndRemoveWithNonThreadSafeListener() {
        ...
        Assert.assertThat(listener.fTestStarted.get(), is(0));
        fNotifier.addListener(listener);
        fNotifier.fireTestStarted(null);
        Assert.assertThat(listener.fTestStarted.get(), is(1));
    ...
    public void wrapIfNotThreadSafeShouldWrapNonThreadSafeListeners() {
        ...
        Assert.assertThat(wrappedListener, instanceOf(SynchronizedRunListener.class));
    }
