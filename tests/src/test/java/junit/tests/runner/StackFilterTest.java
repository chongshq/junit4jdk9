...
public class StackFilterTest extends TestCase {
    ...
    protected void setUp() {
        ...
        pwin.println("junit.j3.framework.AssertionFailedError");
        pwin.println("\tat junit.j3.framework.Assert.fail(Assert.java:144)");
        pwin.println("\tat junit.j3.framework.Assert.assert(Assert.java:19)");
        pwin.println("\tat junit.j3.framework.Assert.assert(Assert.java:26)");
        ...
        pwout.println("junit.j3.framework.AssertionFailedError");
