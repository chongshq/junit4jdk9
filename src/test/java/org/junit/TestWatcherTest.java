...
public class TestWatcherTest {
    ...
    public static class CallbackArguments {
        ...
        public void succeeded() {
            ...
            assertEquals("test(TestWatcherTest$CallbackArguments$Succeeded)",
        ...
        public void failed() {
            ...
            assertEquals("test(TestWatcherTest$CallbackArguments$Failed)",
        ...
        public void skipped() {
            ...
            assertEquals("test(TestWatcherTest$CallbackArguments$Skipped)",
        ...
        public void deprecatedSkipped() {
            ...
            assertEquals("test(TestWatcherTest$CallbackArguments$DeprecatedSkipped)",
        ...
        public void starting() {
            ...
            assertEquals("test(TestWatcherTest$CallbackArguments$Starting)",
        ...
        public void finished() {
            ...
            assertEquals("test(TestWatcherTest$CallbackArguments$Finished)",
