        ...
        return new Object[][]{
                {
                    AddSingleError.class,
                        EventCollector.hasSingleFailureWithMessage("message")},
                {
                    AddTwoErrors.class,
                        EventCollector.hasNumberOfFailures(2)},
                {
                    AddInternalAssumptionViolatedException.class,
                        CoreMatchers.allOf(EventCollector.hasSingleFailure(), EventCollector.hasNoAssumptionFailure())},
                {
                    CheckMatcherThatDoesNotFailWithoutProvidedReason.class,
                        EventCollector.everyTestRunSuccessful()},
                {
                    CheckMatcherThatDoesNotFailWithProvidedReason.class,
                        EventCollector.everyTestRunSuccessful()},
                {
                    CheckMatcherThatFailsWithoutProvidedReason.class,
                        EventCollector.hasSingleFailureWithMessage(Matchers.<String>allOf(
                        ...
                        EventCollector.hasNumberOfFailures(2)},
                {
                    CheckCallableThatThrowsAnException.class,
                        EventCollector.hasSingleFailureWithMessage("first!")},
                {
                        ...
                        EventCollector.everyTestRunSuccessful()},
                {
                    CheckRunnableThatThrowsUnexpectedTypeOfException.class,
                        EventCollector.hasSingleFailureWithMessage("unexpected exception type thrown; expected:<java.lang.IllegalArgumentException> but was:<java.lang.NullPointerException>")},
                {
                    CheckRunnableThatThrowsNoExceptionAlthoughOneIsExpected.class,
                        EventCollector.hasSingleFailureWithMessage("expected java.lang.IllegalArgumentException to be thrown, but nothing was thrown")},
                {
                    ErrorCollectorNotCalledBySuccessfulTest.class,
                        EventCollector.everyTestRunSuccessful()},
                {
                    ErrorCollectorNotCalledByFailingTest.class,
                        EventCollector.hasSingleFailure()},
        };
    }
