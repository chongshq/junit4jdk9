...
import static org.junit.util.internal.matchers.ThrowableMessageMatcher.hasMessage;
 ...
 * }</pre>
 *
 * <p>It is recommended to set the {@link Rule#order() order} of the
 ...
 * provides no useful information. (See {@link Assume} for more
