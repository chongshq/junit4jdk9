...
public abstract class TestWatcher implements TestRule {
    public Statement apply(final Statement base, final Description description) {
        return new Statement() {
            ...
            public void evaluate() throws Throwable {
                ...
                } catch (org.junit.common.internal.AssumptionViolatedException e) {
                    errors.add(e);
    ...
    private void skippedQuietly(
            org.junit.common.internal.AssumptionViolatedException e, Description description,
            List<Throwable> errors) {
        try {
    ...
    protected void skipped(AssumptionViolatedException e, Description description) {
        ...
        org.junit.common.internal.AssumptionViolatedException asInternalException = e;
